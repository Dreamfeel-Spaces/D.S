export async function confirmationEmail({ name, code }: { name: string; code: string }) {
	return `
    <!DOCTYPE html>
    <html
                                            ...
                                            <tr>
                                                ...
                                                >
                                                    <div
                                                        ...
                                                        "
                                                    >
                                                        Dear ${name}, thank you for signing up for Dreamfeel Spaces! We are
