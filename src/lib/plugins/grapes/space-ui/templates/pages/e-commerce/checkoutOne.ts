  ...
  >
    <div class="flex flex-col justify-start items-start w-full space-y-9">
      <div class="flex justify-start flex-col items-start space-y-2">
        ...
        <p
          class="text-base leading-normal sm:leading-4 text-gray-600 dark:text-white"
        >
      ...
      >
        ...
        >
          ...
          >
            <p
              class="text-xl md:text-2xl leading-normal text-gray-800 dark:text-gray-50"
            >
              Logitech K251
            </p>
            <p
              class="text-base font-semibold leading-none text-gray-600 dark:text-white"
            >
              $520.00
            </p>
          </div>
