...
<div class="flex flex-no-wrap dark:bg-black">
	<!-- Sidebar starts -->
	<!-- Remove class [ hidden ] and replace [ sm:flex ] with [ flex ] -->
	<div
		style="min-height: 716px"
		class="w-64 absolute sm:relative bg-blue-800 shadow md:h-full flex-col justify-between hidden sm:flex"
	>
		<div class="px-8">
			<a href="https://pay.dreamfeel.me" class="w-full flex items-cente r">
				<img
					width="80%"
			...
			<ul class="mt-2">
				<li class="flex w-full justify-between text-gray-300 cursor-pointer items-center mb-6">
					...
					>
						...
						<span class="text-sm ml-2">Setup</span>
					</a>
					<!-- <div
	...
	<!-- Sidebar ends -->
	<div class=" mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6">
		<div class="w-full space-y-9 h-screen">
			<!-- div.flex> -->
			<Heading>Setup</Heading>
			<P>Setup via CDN, No installation required.</P>
			<div class="dark:bg-gray-300 p-3 rounded-lg">
