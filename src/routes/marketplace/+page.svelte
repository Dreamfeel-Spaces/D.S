<script>
	import Banner from '$lib/mark/cmps/Banner.svelte';
	import Carousel from '$lib/mark/cmps/Carousel.svelte';
	import Featured from '$lib/mark/cmps/Featured.svelte';
	import Products from '$lib/mark/cmps/Products.svelte';
	import CategoryList from './CategoryList.svelte';
</script>

<div class="flex gap-1 pt-1">
	<div class="w-48 px-2 hidden md:block">
	...
	<div class="w-48 hidden bg-white md:flex h-[100] rounded-xl">
		<dv class="bg-gray-100 mb-2 container h-full flex flex-col rounded-xl pt-9 text-center">
	...
	<div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 gap-4">
		<div class="flex flex-col flex-shrink-0">
			...
			<p class="text-sm leading-none text-gray-800 mt-4 dark:text-white">
				Copyright © 2023 <a href="/">Dreamfeel</a>
			</p>
			...
			<div class="flex items-center gap-x-4 mt-12">
				...
				<a
					href="https://www.linkedin.com/company/dreamfeel"
