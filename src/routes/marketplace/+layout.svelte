...
<div class="bg-gray-300 min-h-screen">
  <div class="bg-primary-700 shadow flex justify-end">
    <img
      src="https://ke.jumia.is/cms/2023/JA23/Teasing/V1/KE_JA23_ACD_Tease_0523_STB.gif"
      alt=""
    />
  </div>

  <nav class="bg-white shadow-lg gap-14 md:flex ">
    <div class="flex md:block justify-between">
      ...
      <img width={"100%"} class="h-68" src={logo} alt="" />
      <!-- <a href="/cart" class="md:hidden relative flex items-center">
        <div
