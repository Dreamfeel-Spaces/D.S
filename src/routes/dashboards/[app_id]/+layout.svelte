	...
	<div class="flex pt-20">
		...
		<div class="w-36  ml-2  pl-4 mr-20  hidden md:block lg:block rounded align-middle  h-72">
			...
			<div class="text-gray-50">
				<div class="mt-20">
					<a class="hover:underline text-blue" href={`/base/${$page.params["app_id"]}`}>Collections API</a>
				</div>
				<div class="mt-6">
					<a class="hover:underline text-blue" href={`/dashboards/${$page.params["app_id"]}`}>Dashboard</a>
				</div>
				<div class="mt-6">
					<a class="hover:underline text-blue" href={`/editor/${$page.params["app_id"]}`}>UI Builder</a>
				</div>
				<div class="mt-6">
					<a rel="external" class="hover:underline text-blue" href={`/${$page.params["app_id"]}`}
						>Website</a
					>
				</div>
			</div>
