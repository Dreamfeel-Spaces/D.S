...
<section class="text-gray-600 body-font">
	<div class="container px-5 py-24 mx-auto">
		<div class="flex flex-col text-center w-full mb-20">
			<h1
				class="text-4xl font-medium title-font mb-4 text-gray-900 dark:bg-gray-300 tracking-widest"
			>
				Our Team
			</h1>
			...
			<div class="p-4 lg:w-1/2">
				...
				>
					...
					<div class="flex-grow sm:pl-8">
						<h2 class="title-font font-medium text-lg text-gray-900">Still DRE</h2>
						<h3 class="text-gray-500 mb-3">10X Developer</h3>
						<p class="mb-4">
